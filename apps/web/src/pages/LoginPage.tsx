      ...
      <div className="hidden md:flex flex-1 flex-col justify-between p-12 bg-dark-400 border-r border-dark-50 relative overflow-hidden">
        <div className="absolute inset-0 opacity-5">
          <div className="absolute inset-0" style={{
            backgroundImage: "radial-gradient(circle at 2px 2px, #d4920f 1px, transparent 0)",
        ...
        <div className="relative">
          ...
          <div>
            ...
            <p className="text-[var(--text-muted)] text-sm">Sistema de agendamento</p>
          </div>
        </div>

        <p className="text-[var(--text-muted)] text-xs">© 2025 The House Barber</p>
      </div>
      ...
      <div className="flex-1 flex flex-col justify-center px-6 md:px-16 py-12">
        ...
        <div className="w-full max-w-sm mx-auto animate-slide-up">
          ...
          <div className="mt-6 text-center">
            <Link to="/" className="text-xs text-[var(--text-muted)] hover:text-[var(--text-secondary)] transition-colors">
